...
bool A2DP_IsVendorSinkCodecValidLhdcV5([[maybe_unused]] const uint8_t* p_codec_info) {
  return false;
  // tA2DP_LHDCV5_CIE cfg_cie;
...
int A2DP_VendorGetBitRateLhdcV5([[maybe_unused]] const uint8_t* p_codec_info) {
...
bool A2dpCodecConfigLhdcV5Sink::init() {
  log::info("LHDC V5: Sink role not supported - decoder not available");
